...
if page == "ᯓ★ ML Description":
    ...
    st.info("""
**Ensemble Model** คือเทคนิคที่นำโมเดลพื้นฐาน (Base Learners) หลายตัวมาทำงานร่วมกัน เพื่อรวมจุดแข็งและเฉลี่ยข้อผิดพลาดเข้าด้วยกัน ทำให้ได้ผลลัพธ์ที่มีความแม่นยำและเสถียร (Robustness) 
